...
const mockKpis = [
  { label: 'Active Schools', value: '24', change: '+2 this month' },
  { label: 'Total Students', value: '15,420', change: '+320 this term' },
  { label: 'Attendance Rate', value: '94%', change: '+1.2% this week' },
  { label: 'Average Grade', value: 'B+', change: '+0.3 this term' },
];

const mockAttendanceByGrade = [
...
const mockTopSchools = [
  ...
  { name: 'Adama Model School', region: 'Oromia', attendance: '96%', grade: 'A-' },
  { name: 'Bahir Dar Academy', region: 'Amhara', attendance: '95%', grade: 'B+' },
];
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              High-level overview of school performance across the DebterLink network.
            </p>
          </div>
